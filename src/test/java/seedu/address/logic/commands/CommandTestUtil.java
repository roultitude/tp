...
public class CommandTestUtil {
    ...
    public static final EditCommand.EditEntityDescriptor DESC_AMY;
    public static final EditCommand.EditEntityDescriptor DESC_BOB;

    static {
        DESC_AMY = new EditEntityDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditEntityDescriptorBuilder().withName(VALID_NAME_BOB)
